...
class Register:
        def __init__(self,root):
            ...
            txt_mname=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=500,y=70)
            ...
            add1=Label(frame1,text="PRESENT ADDRESS  ",font=("verdana",10,"bold"),bg="white",fg="black").place(x=10,y=150)
            txt_add1=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=150,y=150)

            add2=Label(frame1,text="PERMANENT ADDRESS  ",font=("verdana",10,"bold"),bg="white",fg="black").place(x=320,y=150)
            txt_add2=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=500,y=150)

            # CLASS 10 #
            ten=Label(frame1,text="X BOARD MARKS",font=("verdana",10,"bold"),bg="white",fg="black").place(x=10,y=170)
            txt_ten=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=150,y=170)
            # CLASS 12 #
            twelve=Label(frame1,text="XII BOARD MARKS",font=("verdana",10,"bold"),bg="white",fg="black").place(x=320,y=170)
            txt_twelve=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=500,y=170)
            
            # BOARD NAME #
            
            board=Label(frame1,text="BOARD",font=("verdana",10,"bold"),bg="white",fg="black").place(x=10,y=190)
            cmb_board=ttk.Combobox(frame1,font=("verdane",10,"bold"))
            cmb_board['values']=("ISC","WBBSE","CBSE","OTHER")
            cmb_board.place(x=150,y=190)
            other=Label(frame1,text="SPECIFY IF OTHER",font=("verdana",10,"bold"),bg="white",fg="black").place(x=320,y=190)
            txt_other=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=500,y=190)

            # PCM MARKS #
            phy=Label(frame1,text="MARKS IN PHY",font=("verdana",10,"bold"),bg="white",fg="black").place(x=10,y=210)
            txt_phy=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=150,y=210)

            chem=Label(frame1,text="MARKS IN CHEM",font=("verdana",10,"bold"),bg="white",fg="black").place(x=10,y=230)
            txt_chem=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=150,y=230)

            math=Label(frame1,text="MARKS IN MATH",font=("verdana",10,"bold"),bg="white",fg="black").place(x=10,y=250)
            txt_math=Entry(frame1,font=("verdana",10),bg="lightgray").place(x=150,y=250)
